...
function getSharedSecret(privateKey, publicKey) {
    ...
    try {
        ...
        return (0, hkdf_1.extract)(sha256_1.sha256, shared_x, salt);
    }
    catch (error) {
...
function getMessageKeys(conversation_key, nonce) {
    ...
    const keys = (0, hkdf_1.expand)(sha256_1.sha256, conversation_key, nonce, 76);
...
function generateNonce() {
    return (0, utils_1.randomBytes)(NONCE_SIZE);
}
/**
...
function hmacWithAAD(key, message, aad) {
    ...
    return (0, hmac_1.hmac)(sha256_1.sha256, key, (0, utils_1.concatBytes)(aad, message));
}
/**
 ...
 */
function encrypt(plaintext, privateKey, publicKey, nonce) {
    // Validate keys
    if (!isValidPublicKey(publicKey)) {
        throw new Error('NIP-44: Invalid public key format. Expected 64-character hex string.');
    }
    ...
    try {
        ...
        const payload = (0, utils_1.concatBytes)(new Uint8Array([VERSION]), // Version byte
