...
async function main() {
    ...
    console.log('\nConfiguring bunker...');
    const bunker = new src_1.NostrRemoteSignerBunker({
        relays,
    ...
    // Create client
    console.log('\nInitializing client...');
    const client = new src_1.NostrRemoteSignerClient({
        relays,
    ...
    try {
        ...
        console.log('Signature valid:', (0, src_1.verifySignature)(signedNote.id, signedNote.sig, signedNote.pubkey));
        // Sign an encrypted DM
        console.log('\nSigning an encrypted DM...');
        const recipient = await (0, src_1.generateKeypair)();
        ...
        // Verify the signature using the user's public key
        console.log('Signature valid:', (0, src_1.verifySignature)(signedDm.id, signedDm.sig, signedDm.pubkey));
