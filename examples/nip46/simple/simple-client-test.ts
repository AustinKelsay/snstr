import { SimpleNIP46Client, SimpleNIP46Bunker, generateKeypair, verifySignature } from '../../../src';
...
async function main() {
  ...
  try {
    ...
    console.log('\nStarting bunker...');
    const bunker = new SimpleNIP46Bunker([relayUrl], userKeypair.publicKey, signerKeypair.publicKey);
