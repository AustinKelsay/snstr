...
function demonstrateNprofileEncoding() {
  ...
  const relaysMatch = decoded.relays && JSON.stringify([...decoded.relays].sort()) === JSON.stringify([...relays].sort());
...
function demonstrateNeventEncoding() {
  ...
  const author = '32e1827635450ebb3c5a7d12c1f8e7b2b514439ac10a67eef3d9fd9c5c68e245';
  const relays = [
    'wss://relay.nostr.info',
    'wss://relay.damus.io'
  ];
...
function demonstrateNaddrEncoding() {
  ...
  const pubkey = 'e8b487c079b0f67c695ae6c4c2552a47f38adfa2533cc5926bd2c102942fdcb5';
...
function explainTLVFormat() {
  ...
  console.log('TLV (Type-Length-Value) format allows encoding complex entities with multiple fields:');
  ...
  console.log('- Including multiple pieces of information in a single Bech32 string');
