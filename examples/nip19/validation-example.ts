...
/**
 * Demonstrates kind validation for naddr
 */
function demonstrateKindValidation() {
  console.log("\n=== Kind Validation for naddr ===");

  const baseAddrData = {
    pubkey: "3bf0c63fcb93463407af97a5e5ee64fa883d107ef9e558472c4eb9aaaefa459d",
    identifier: "test-kind-validation",
  };
  ...
  kindTestCases.forEach(({ name, kind, shouldPass }) => {
    try {
      ...
      if (shouldPass) {
        ...
        console.log(`✅ ${name}: Failed as expected: ${errorMessage}`);
      }
    }
  });
