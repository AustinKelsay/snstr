...
import { generateKeypair, encryptNIP04, decryptNIP04, getNIP04SharedSecret } from '../../src';
...
async function main() {
  try {
    ...
    const aliceSecret = getNIP04SharedSecret(aliceKeypair.privateKey, bobKeypair.publicKey);
    const bobSecret = getNIP04SharedSecret(bobKeypair.privateKey, aliceKeypair.publicKey);
