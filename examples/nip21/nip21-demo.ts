...
const noteId = '1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef';
...
console.log('   https://example.com/user/' + encodePublicKey(alice.publicKey));
console.log('   Could redirect to: nostr:' + encodePublicKey(alice.publicKey));
console.log();

console.log('📧 QR Codes:');
console.log('   Encode this URI in a QR code:');
console.log('   nostr:' + encodeProfile({
  pubkey: alice.publicKey,
  relays: ['wss://relay.damus.io']
}));
console.log();
