...
console.log(`Removed ${originalProfileRelayCount - filteredProfileRelays.length} unsafe relays`);
...
console.log(`Removed ${originalEventRelayCount - filteredEventRelays.length} unsafe relays`);
...
console.log(`Profile: ${profileCopy.relays.length} relays -> ${safeProfile.relays.length} safe relays`);
console.log(`Event: ${eventCopy.relays.length} relays -> ${safeEvent.relays.length} safe relays`);
console.log(`Address: ${addressCopy.relays.length} relays -> ${safeAddress.relays.length} safe relays`);
