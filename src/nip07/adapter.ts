...
export class Nip07Nostr extends Nostr {
   ...
   */
  override async generateKeys(): Promise<{ privateKey: string; publicKey: string }> {
   ...
   */
  override async publishTextNote(content: string, tags: string[][] = []): Promise<NostrEvent | null> {
