...
- CodeRabbit reports: local `coderabbit-local-cleanup-1-8.md` was rate-limited with a passing fallback; final PR round recorded in `coderabbit-round-3.md`
...
| #94 Correct coverage exclusions | AFK | completed | `issue-94-review-packet.md` | — | 66 suites / 879 tests; lcov inventory |
...
| Item 8 (#98) | `29a51d5` | orchestrator + OpenCode inspection | `5614605`, `292d90b`, `b622656`, `70b7eb8` | pass/pass after follow-ups | 66/879, build, pack, runtime/type condition resolution |
