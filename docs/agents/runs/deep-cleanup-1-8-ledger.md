...
| #116 ephemeral Relay ownership       | AFK  | implementation, local review, and full matrix verified | `feature/ephemeral-relay-ownership`     | standards/spec pass; local CodeRabbit clean                                                              | focused lifecycle/integration 25/25; full Jest/Bun 1026/1026; commands, lint, types, builds, examples, pack      |
...
| #116  | `9e3aca8`   | current Codex orchestrator; Grok unavailable at auth preflight | pending                  | standards/spec pass; local CodeRabbit clean                                                                                   | focused lifecycle/integration Bun 25/25; full Jest/Bun 1026/1026; commands, lint, types, builds, examples, pack                    |
