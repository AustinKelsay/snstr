...
- Human owner: plebdev
- Started: 2026-07-18
- Current status: issues #112, #118, #113, #114, and #115 merged into `staging`; issue #116 implementation, local review, and full matrix verified
...
- PR URLs: #120 for issue #112, #121 for issue #118, #122 for issue #113, #123 for issue #114, #124 for issue #115 (all merged); later tickets pending
...
| #116 ephemeral Relay ownership       | AFK  | hosted review fixes implemented | `feature/ephemeral-relay-ownership`     | standards/spec pass; local CodeRabbit clean; hosted 2 fixed, 2 unrelated skips                           | focused lifecycle/integration 25/25; full Jest/Bun 1026/1026; commands, lint, types, builds, examples, pack      |
...
| #116  | `9e3aca8`   | current Codex orchestrator; Grok unavailable at auth preflight | pending                  | standards/spec pass; local CodeRabbit clean; hosted 2/2 package findings fixed, 2 unrelated NIP-02 findings skipped           | focused lifecycle/integration Bun 25/25; full Jest/Bun 1026/1026; commands, lint, types, builds, examples, pack                    |
