import { getSharedSecret, encrypt, decrypt, NIP04DecryptionError } from '../../src/nip04';
import { secp256k1 } from '@noble/curves/secp256k1';
import { bytesToHex } from '@noble/hashes/utils';

// Keys for testing
const alicePrivateKey = 'a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1';
const alicePublicKey = bytesToHex(secp256k1.getPublicKey(alicePrivateKey, true).slice(1));

const bobPrivateKey = 'b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2';
...
describe('NIP-04 Input Validation', () => {
  ...
  test('should reject message with invalid base64 IV', () => {
    ...
    const validCiphertext = encrypt('test', alicePrivateKey, bobPublicKey).split('?iv=')[0];
    const invalidIV = 'invalid!iv!';
    
    expect(() => {
      decrypt(`${validCiphertext}?iv=${invalidIV}`, bobPrivateKey, alicePublicKey);
  ...
  test('should reject message with incorrect IV length', () => {
    ...
    expect(() => {
      decrypt(`${validCiphertext}?iv=${shortIV}`, bobPrivateKey, alicePublicKey);
